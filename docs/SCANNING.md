...
marker rows (`E0712`/`E0715`/`E0716`/`E0717`/`E0724`/`E0725`/`E0726`/
`E0728`/`E0729`/`E0730`); and the static-semantic family `E0202`–`E0207`.
Python has no declared `effects` clause and no marker types.
